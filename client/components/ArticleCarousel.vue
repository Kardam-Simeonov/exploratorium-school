...
export default {
  ...
  methods: {
    ...
    nextSlide () {
      this.currentSlide = this.currentSlide === Object.keys(this.carouselSlides).length - 1 ? 0 : this.currentSlide + 1
    },
    previousSlide () {
      this.currentSlide = this.currentSlide === 0 ? Object.keys(this.carouselSlides).length - 1 : this.currentSlide - 1
    }
  }
}
</script>

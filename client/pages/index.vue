<template>
  <div class="relative">
    <nuxt-img
      ...
      format="webp" preload width="1000" alt="Kids sitting on stairs" src="/stock/kids-stairs.jpg" />
    <div
    ...
    <section
      ...
      <nuxt-img
        ...
        format="webp" width="1920px" preload alt="Kids sitting on stairs"  src="/stock/kids-stairs.jpg" />

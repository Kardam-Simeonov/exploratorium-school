<template>
    <div class="relative pt-72">
      <header class="relative px-12">
        ...
        <nuxt-img class="lg:block hidden aspect-[6/5] 1xl:w-[48%] w-[55%] ml-auto absolute left-0 -right-1 bottom-[12%] object-cover object-center mask-header" src="/stock/drawing.jpg" />
        <nuxt-img class="lg:hidden block h-[23rem] w-full absolute -top-[55%] left-0 object-cover object-center mask-header-mobile opacity-80" src="/stock/drawing.jpg" />
      ...
      <!-- Content -->
        <section class="mx-auto mt-16 mb-28 px-6 lg:max-w-[75rem] md:max-w-4xl max-w-lg">

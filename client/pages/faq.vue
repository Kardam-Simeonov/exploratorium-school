  ...
  <div class="relative pt-56">
    ...
    <header class="relative px-4">
      ...
      <div class="mx-auto w-fit mb-6 xl:p-32 rounded-3xl relative overflow-hidden">
        ...
        <nuxt-img preload width="1200px" class="xl:block hidden absolute inset-0 z-0 w-full h-full object-cover opacity-90" src="/stock/englishTeacher.jpeg" />
      </div>
    </header>

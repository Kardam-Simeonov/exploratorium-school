    ...
    <div class="relative 1xl:pt-[21rem] pt-64">
      ...
      <header class="relative lg:pl-12 px-4">
        ...
        <nuxt-img
          ...
          format="webp"
          :placeholder="[4, 3]"
          class="xl:block hidden aspect-[5/4] w-[48%] ml-auto absolute left-0 -right-1 bottom-0 object-cover object-center mask-header" src="/stock/staff1.jpg" />
        ...
        <div class="xl:min-h-[28rem] min-h-[20rem] max-w-7xl mx-auto animate-fade-down">
          <div class="max-w-[35rem] relative">
            <h1 class="font-lobster text-left 1xl:text-[4rem] text-[3.5rem] leading-none text-explo-darkgreen mb-5 drop-shadow-text">
              За Нас
            </h1>
